...
export const ClientTerminalInputMessageSchema = z
	...
	.strict();
export type ClientTerminalInputMessage = z.infer<
	typeof ClientTerminalInputMessageSchema
>;
...
export const ClientDisconnectMessageSchema = z
	...
	.strict();
export type ClientDisconnectMessage = z.infer<
	typeof ClientDisconnectMessageSchema
>;

export const ClientSessionActivityMessageSchema = z
	.object({
		...ClientMessageBase,
	...
	.strict();
export type ClientSessionActivityMessage = z.infer<
	typeof ClientSessionActivityMessageSchema
>;
...
export const ClientShellHistoryMessageSchema = z
	...
	.strict();
export type ClientShellHistoryMessage = z.infer<
	typeof ClientShellHistoryMessageSchema
>;
...
export const ClientSftpWriteMessageSchema = z
	...
	.strict();
export type ClientSftpWriteMessage = z.infer<
	typeof ClientSftpWriteMessageSchema
>;
...
export const ClientSftpMkdirMessageSchema = z
	...
	.strict();
export type ClientSftpMkdirMessage = z.infer<
	typeof ClientSftpMkdirMessageSchema
>;
...
export const ClientSftpRenameMessageSchema = z
	...
	.strict();
export type ClientSftpRenameMessage = z.infer<
	typeof ClientSftpRenameMessageSchema
>;
...
export const ClientSftpDeleteMessageSchema = z
	...
	.strict();
export type ClientSftpDeleteMessage = z.infer<
	typeof ClientSftpDeleteMessageSchema
>;
...
export const ClientSftpChmodMessageSchema = z
	...
	.strict();
export type ClientSftpChmodMessage = z.infer<
	typeof ClientSftpChmodMessageSchema
>;
...
export const ClientWebSocketMessageSchema = z
	.union([
		...
		ClientSessionActivityMessageSchema,
	...
	.refine(
		hasValidJsonSize,
		`JSON messages must not exceed ${MAX_JSON_MESSAGE_BYTES} bytes`,
	);
...
export const MetricSupportSchema = z.enum([
	"supported",
	"unsupported",
	"error",
]);
...
export const ServerShellHistoryResultMessageSchema = z
	...
	.strict();
export type ServerShellHistoryResultMessage = z.infer<
	typeof ServerShellHistoryResultMessageSchema
>;
...
export type ServerFileResultMessage = z.infer<
	typeof ServerFileResultMessageSchema
>;
...
export type ServerTransferReadyMessage = z.infer<
	typeof ServerTransferReadyMessageSchema
>;
...
export const ServerTransferProgressMessageSchema = z
	...
	.superRefine((value, context) => {
		if (
			...
			value.acknowledgedOffset > value.totalBytes
		) {
			context.addIssue({
				code: "custom",
