...
export const TailscaleDeviceListResponseSchema = z
  ...
  .strict();
export type TailscaleDeviceListResponse = z.infer<typeof TailscaleDeviceListResponseSchema>;

export const TailscaleImportRequestSchema = z
  .object({
    deviceIds: z.array(z.string().min(1).max(128)).min(1).max(50)
      .refine((value) => new Set(value).size === value.length, "Device identifiers must be unique"),
...
export type TailscaleImportRequest = z.infer<typeof TailscaleImportRequestSchema>;
...
export const TailscaleImportSkippedSchema = z
  ...
  .strict();
export type TailscaleImportSkipped = z.infer<typeof TailscaleImportSkippedSchema>;
...
export const TailscaleImportResponseSchema = z
  ...
  .strict();
export type TailscaleImportResponse = z.infer<typeof TailscaleImportResponseSchema>;
