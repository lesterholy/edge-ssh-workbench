...
export const api = {
  ...
  startGoogleLogin: () =>
    request<GoogleAuthorizationStartResponse>("/api/auth/google/start", { method: "POST" }),
  login: (input: LoginRequest) =>
    request<AuthState>("/api/auth/login", { method: "POST", body: JSON.stringify(input) }),
  logout: () => request<void>("/api/auth/logout", { method: "POST" }),
  startTotpEnrollment: () =>
    request<TotpEnrollmentStartResponse>("/api/auth/totp/setup", { method: "POST" }),
  ...
  createProfile: (input: ProfileCreateRequest) =>
    request<ProfileResponse>("/api/profiles", { method: "POST", body: JSON.stringify(input) }),
  ...
  deleteProfile: (id: string) =>
    request<void>(`/api/profiles/${encodeURIComponent(id)}`, { method: "DELETE" }),
  ...
  createTicket: (input: SshTicketRequest) =>
    request<SshTicketResponse>("/api/ssh/tickets", { method: "POST", body: JSON.stringify(input) }),
