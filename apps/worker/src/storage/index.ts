...
export * from "./tailscale-configuration";
export * from "./users";
...
export interface Repositories {
	...
	tailscaleConfiguration: TailscaleConfigurationRepository;
...
export function createRepositories(
	env: Pick<Env, "DB" | "CREDENTIAL_MASTER_KEY">,
): Repositories {
	return {
		...
		tailscaleConfiguration: new TailscaleConfigurationRepository(
			env.DB,
